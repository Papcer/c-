...
void pokaz_inne_warianty_funkcji_kwadratowej(FunkcjaKwadratowaWartosci& fun) 
{
    todo:
int wybor;
cout << "Na jaka postac funkcji chcesz przeliczyc" << endl;
...
cin >> wybor;
    ...
    if (wybor == 1)
    {
        cout << "Postac funkcji" << endl;
        cout << fun.a << "x+ " << fun.b << "y+ " << fun.c << " = 0" << endl;
        system("pause");
        system("cls");
        goto todo;
    }
    ...
    {
        cout << "Postac iloczynowa " << endl;
        cout << fun.a << "( x - " << fun.x1 << " )( x - " << fun.x2 << " ) " << endl;
        system("pause");
        system("cls");
        goto todo;
    }
